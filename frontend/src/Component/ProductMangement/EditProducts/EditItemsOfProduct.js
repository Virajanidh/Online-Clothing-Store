...
class EditItemsOfProduct extends Component{
    ...
    onEdit = (e,index) => {
        e.preventDefault();
        axios.put('https://clothappbackend.herokuapp.com/products/editItemOfProduct/' + this.props.match.params.id, this.state.Products.Details[index])
            .then((res) => {
    ...
    onDelete = (e,color) => {
        ...
        axios.put('https://clothappbackend.herokuapp.com/products/deleteOneItemFromProduct/' + this.props.match.params.id + "/" + color)
            .then((res) => {
                console.log(res.data)
